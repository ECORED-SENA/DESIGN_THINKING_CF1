...
.curso-main-container.pb-3
  ...
  .container.tarjeta.tarjeta--blanca.p-4.p-md-5
    ...
    .row.justify-content-center.align-items-center.mb-4
      .col-12.col-lg-6
          p La fase inicial del <i>Design Thinking</i> busca, a través de diferentes herramientas, entender las necesidades reales en el contexto del usuario para lograr generar soluciones pertinentes y eficientes para el problema planteado. 
    ...
    .row.justify-content-center.align-items-center.mt-5.mb-3
      .col-lg-5.mb-4.mb-lg-0(data-aos="fade-right")
          img(src='@/assets/curso/images/tema3/img_2.svg' alt="", style="width:450px; display:block; margin:auto;")
    ...
    .row.justify-content-center.align-items-center.mb-4
      .col-lg.order-2.order-lg-1
        .custom_box_right    
          ...
          b(style="color: #214BE5;") Entender lo que las personas sienten, escuchan, cómo se comportan, lo que dicen y hacen, qué los motiva y qué los frustra es un buen punto de partida.   
      .col-auto.mb-5.mb-lg-0.onTop.order-1.order-lg-2(data-aos="fade-left")
        img(src="@/assets/curso/images/tema3/img_13.svg" alt='AvatarTop', style="width:330px;").m-auto
        ...
        .jumbotron-11.p-4
          .row
            .col-lg-1.mb-4.mb-lg-0
              img(src='@/assets/curso/images/tema3/ico_13.svg' alt="", style="width:5px; display:block; margin:auto; 0")
            .col-lg-7.mb-4.mb-lg-0
              p Luego de responder estas preguntas iniciales, se concluye el mapa de empatía con dos preguntas más:
    ...
    .row.justify-content-center.align-items-center.mt-5.mb-5
      .col-lg-7.mb-4.mb-lg-0
        p.mb-2(style="color: #214BE5;") <b> Creación del arquetipo </b>
          ...
          p.mb-0 Para crearlos se debe partir de la recolección de información desde lo general a lo particular con el objetivo de definir la esencia y los patrones de conducta del grupo de usuarios que queremos impactar. 
      .col-lg-5.mb-4.mb-lg-0(data-aos="fade-left")
          img(src='@/assets/curso/images/tema3/img_17.svg' alt="", style="width:400px; display:block; margin:auto;") 

    .row.fondo-6.p-5.mb-5
      .col-lg-6.mb-4.mb-lg-0
          b.mb-3(style="color: #214BE5;") <b> Proceso de creación del arquetipo “de lo general a lo particular” </b>
