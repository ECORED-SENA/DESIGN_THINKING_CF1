...
.curso-main-container.pb-3
  ...
  .container.tarjeta.tarjeta--blanca.p-4.p-md-5
    ...
    .row.justify-content-center.align-items-center.mt-5.mb-3
      .col-auto
          img(src='@/assets/curso/images/tema3/img_2.svg' alt="", style="width:330px; display:block; margin:auto;")
      .col-8
    ...
    .row.justify-content-center.align-items-center.mb-4
      ...
      .col-auto.onTop.order-1.order-lg-2
        img(src="@/assets/curso/images/tema3/img_13.svg" alt='AvatarTop', style="width:320px;").m-auto
